    ...
    <style>
        ...
        *
        ...
        @keyframes change
        {
            ...
            80%
            {
                background-image: url(RebelMoon.jpg);
            }
            100%
            {
...
<body>
    <div class="outer">
        <div class="inner">
            ...
            <a href="adminsignin.jsp"><button class="one"><i class="fa-solid fa-user-plus"></i> ADMIN SIGNIN</button></a>
            <a href="adminsignup.jsp"><button class="two"><i class="fa-solid fa-users"></i> ADMIN SIGNUP</button></a>
        </div>
    </div>
